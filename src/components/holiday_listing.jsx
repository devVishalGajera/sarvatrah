...
const Holiday_list = () =>{
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`http://127.0.0.1:3232/holidays/packages`);
            ...
            <div className="hl-body-section">
                <div className="hl-sidebar" id={isTransformed?'hl-filter':'on-hl-filter'}>
                    ...
                    <div className="tour-dur">
                      ...
                      <li> <input type="checkbox" name="l-6" id="l-h" />
                        <label htmlFor='l-6'>Less than 6 Night</label> </li>
                        <p>56</p>
                      </div>
                      <div className="tour-check">
                      <li> <input type="checkbox" name="7-9" id="l-h" />
                        <label htmlFor='7-9'>07 - 09 Nights</label> </li>
                        <p>56</p>
                      </div>
                      <div className="tour-check">
                      <li> <input type="checkbox" name="h-10" id="l-h" />
                        <label htmlFor='h-10'>More than 10 Nights</label> </li>
                        <p>56</p>
                      </div>
                    ...
                    <li> <input type="checkbox" name="couple" id="l-h" />
                        <label htmlFor='counple'>Couples</label> </li>
                    <li> <input type="checkbox" name="honeymoon" id="l-h" />
                        <label htmlFor='honeymoon'>Honeymoon</label> </li>
                      <li> <input type="checkbox" name="Family" id="l-h" />
                        <label htmlFor='Family'>Family</label> </li>
                        <li> <input type="checkbox" name="Adventure" id="l-h" />
                        <label htmlFor='Adventure'>Adventure</label> </li>
                        <li> <input type="checkbox" name="Deals" id="l-h" />
                        <label htmlFor='Deals'>Hot Deals</label> </li>
                    </div>
                </div>
                <div className="hl-main-body">
                        <i className="filter-small"  onClick={toggleChange}><BsFilterSquareFill /></i>
                        <h1 id="hl-total-card">{apidata.length} Destinations <span>in India</span></h1>
                        <div className="hl-grid">
                          {apidata.map((value) =>(
                            <Link to = {`/holiday/details/${value.id}`} style={{textDecoration:'none',color:'black'}}>
                            <div className="hl-card">
                              <div className="image-duration">
                                <img src={value.image} alt="" />
                                <h1>{value.duration.days}D - {value.duration.night}N</h1>
                              </div>
                              ...
                              <div className="card-t-info">
                                     ...
                                     <p>{wordToTitleCase(value.startPlace[0])} to {wordToTitleCase(value.startPlace[1])}</p>
                                     </div>
                                  ...
                                  <div className="hl-card-price">
                                     <div class='price-checks'>
                                       ...
                                       <h5 class='true-price'>INR {value.price} <span> /per person </span></h5>
                                     </div>
