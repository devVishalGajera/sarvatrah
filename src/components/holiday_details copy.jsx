...
const HolidayDetails = () =>{
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`http://127.0.0.1:3232/holidays/package/details/${id}`);
  ...
  return (
    <div className="holidayDetails">
      <div className="hd_head">
        ...
        <p className="duration">{apidata.packageDuration.days}D - {apidata.packageDuration.night}N </p>
        <div className="gallery">
          <div className="allgallery">
              <div class="image"><img src={img1} alt="Image 1"/>
              <h4 className="section_title">View Gallery</h4>
              </div>
              
          </div>
          <div className="gallery_video">
            <div class="image"><img src={img2} alt="Image 2"/></div>
          </div>
          <div className="activity_gallery">
          <div class="image"><img src={img3} alt="Image 3"/></div>
          </div>
          <div className="property_gallery">
          <div class="image"><img src={img4} alt="Image 3"/></div>
          </div>
      ...
      <div className="hd-body"> 
        ...
        />
          ...
          <div className="person_count">
            ...
            <Typography variant="body" color="primary">Adults</Typography>
      ...
      {apidata.apidata.itinerary.map((data) =>(
            ...
            <div className="hd-activities">
              ...
              if (act.objType ==='hotel'){
                return (
                  <ActCard url={`http://127.0.0.1:3232/activity?id=${act.activityID}&type=${act.objType}`} type="hotel" />
              ...
              if (act.objType ==='car'){
                return (
                  <ActCard url={`http://127.0.0.1:3232/activity?id=${act.activityID}&type=${act.objType}`} type="car" />
