    ...
    return(
            <div className="footerComponent">
              <div className="compInfo">
                ...
                <img src={logo} class ="icon-footer" alt="" />
                <p>Sarvatrah</p>
                </div>
                <img src={iconMap} class ="icon-footer" alt=""/>
                <p>Opposite Gyuto Monastery Gate, Sidhbari Dharamshala - 176057, Himachal Pradesh, India.</p>
                
              </div>
              <div className="call about">
                <img src={phone} class='about-logo' alt="" />
                <p>Call us</p>
                <h4>+91 999 934 5782</h4>
                <h4>+91 981 104 5962</h4>
            
                <img src={inbox} class='about-logo' alt="" />
                <p>Email us</p>
                <h4>+91 999 934 5782</h4>
                <h4>+91 981 104 5962</h4>
              </div>
              <div className="pages">
                <p><a href="">Home</a>
      </p>          <p><a href="">Adventure</a>
 </p>               <p><a href="">Activities</a>
</p>                <p><a href="">Holidays</a>
  </p>              <p><a href="">Pilgrimages</a></p>
                <p><a href="">Contact</a>
