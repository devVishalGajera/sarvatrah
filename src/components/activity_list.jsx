...
const Activity_list = () =>{
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`http://127.0.0.1:3232/activities/`);
        ...
        <div className="holi_list">
            <div className="actl-search">
                ...
                <div className="actl-search-op">
                    <div className="input-actl-search-op">
                        ...
                        <input type="text" name="seach-actl" id="search" placeholder='Enter Location or Select from list'/>
            ...
            <div className="hl-body-section">
                <div className="hl-sidebar" id={isTransformed?'hl-filter':'on-hl-filter'}>
                    ...
                    <li> <input type="checkbox" name="l-h" id="l-h" />
                        <label htmlFor='l-h'>Coasteering</label> </li>
                    <li> <input type="checkbox" name="l-h" id="l-h" />
                        <label htmlFor='l-h'>Canyoning
</label> </li>
                      <li> <input type="checkbox" name="l-h" id="l-h" />
                        <label htmlFor='l-h'>Sky diving</label> </li>
                        <li> <input type="checkbox" name="l-h" id="l-h" />
                        <label htmlFor='l-h'>Adventure</label> </li>
                        <li> <input type="checkbox" name="l-h" id="l-h" />
                ...
                <div className="actl-main-body">
                        ...
                        <h1 id="hl-total-card">{apidata.length} Activities <span>in India</span></h1>
                        <div className="actl-grid">
                          {apidata.map((value) =>(
                        <Link to = {`/activity/details/${value._id}`} style={{textDecoration:'none',color:'black'}}>
                            ...
                            <div className="actl-card">
                              ...
                              <div className="card-t-info">
                                     ...
                                     <p>{value.activityLocation}</p>
                                      ...
                                      <p>Duration <span>{value.packageDuration}:00 Hours</span></p>
                                      </div>
                                  ...
                                  <div className="hl-card-price">
                                     <div class='price-checks'>
                                       <p class='false-price'>INR <del>3,601</del></p>
