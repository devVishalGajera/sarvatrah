...
export const RegistrationPage = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:6006/api/user/register", {
                method: "POST",
                headers: {
    ...
    return (<div className={Style.Rcontainer}>
        <div className={Style.Rinner}>
            ...
            <div>
                ...
                <div>
                    <input
                        ...
                        onChange={(e) =>
                            setValues((prev) => ({ ...prev, contactNumber: e.target.value }))
                        }
                    />
                </div>
                <div>
            ...
            <p className={Style.dontText}>Login to your account!
                <span>
                    <Link to="/login">
                        {" "}
                        Login
